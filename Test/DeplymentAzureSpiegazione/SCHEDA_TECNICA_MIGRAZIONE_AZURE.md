...
- [deploy-api.ps1](D:\Scuola\5IA\INFO\ClaudeCode\Test\deploy-api.ps1)
- [deploy-frontend.ps1](D:\Scuola\5IA\INFO\ClaudeCode\Test\deploy-frontend.ps1)
...
```powershell
.\deploy-frontend.ps1 -Tag v1.0.1
```

e poi:

```powershell
.\deploy-frontend.ps1 -Tag v1.0.2
```
...
Il risultato finale e una struttura piu professionale: il progetto resta sviluppabile in locale, ma puo essere pubblicato online in modo ripetibile attraverso gli script `deploy-api.ps1` e `deploy-frontend.ps1`.
